...
- Harness Lens is a local-first, read-only Agent Harness inspector before it becomes an orchestration platform.
...
- The app is read-only in MVP. Opening a source file externally is allowed; editing or deleting Harness files is not.
